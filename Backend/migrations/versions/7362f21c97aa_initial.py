...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("member", "admin", "manager", name="user_roles"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "issue_date", sa.DateTime(), server_default=sa.text("now()"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("approved", "pending", name="join_request_enum"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("done", "running", "failed", name="project_status"),
            nullable=True,
        ),
        sa.Column(
            "created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=True
        ...
        sa.Column(
            "urgency",
            sa.Enum("high", "low", "medium", name="project_urgency"),
            nullable=True,
        ),
        sa.Column("company_id", sa.UUID(), nullable=True),
        sa.ForeignKeyConstraint(["company_id"], ["companies.id"], ondelete="CASCADE"),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "completed", "failed", name="task_status"),
            nullable=True,
        ),
